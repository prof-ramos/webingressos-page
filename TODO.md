...
- [x] Tema escuro promovido para a landing principal com a direção aprovada na
      ...
      Archivo em produto/dados. A landing `/` é a implementação canônica e o
      protótipo externo não foi incorporado como rota ou dependência. Validação
      local concluída nos breakpoints definidos, sem overflow.
