...
export default function PrivacyPolicyPage() {
  return (
    <main id="main-content" className="min-h-screen bg-surface-deep px-5 py-16 sm:py-20">
      <div className="mx-auto max-w-3xl">
        ...
        <article className="mt-10">
          <h1 className="font-display text-4xl tracking-tight text-foreground uppercase sm:text-5xl">
          ...
          <h2 className="mt-12 text-xl font-bold text-foreground">1. Informações coletadas</h2>
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
            Ao preencher nosso formulário de contato, podemos coletar os seguintes dados pessoais:
          </p>
          <ul className="mt-3 list-disc space-y-1.5 pl-6 text-base leading-relaxed text-muted-foreground marker:text-accent">
            <li>Nome completo;</li>
          ...
          <h2 className="mt-12 text-xl font-bold text-foreground">2. Uso das informações</h2>
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
          ...
          <h2 className="mt-12 text-xl font-bold text-foreground">3. Compartilhamento de dados</h2>
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
          ...
          <h2 className="mt-12 text-xl font-bold text-foreground">4. Segurança dos dados</h2>
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
          ...
          <h2 className="mt-12 text-xl font-bold text-foreground">5. Seus direitos</h2>
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
          ...
          <div className="mt-16 border-t border-border pt-8">
            <Link
              href="/"
              className="inline-flex h-12 items-center justify-center rounded-lg bg-primary px-6 text-sm font-bold text-primary-foreground transition-[background-color,box-shadow] hover:bg-brand-400 hover:shadow-cta"
            >
              Voltar ao site
            </Link>
          </div>
